...
@section('content')
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading" style="display: flex">
                <div class="col-md-11 col-sm-1" style="color:white;margin-top:16px">Midcap- Option Chain</div>
                        ...
                        <tbody class="callCurrentData"style="color: white">
                            ...
                            <tr>
                                ...
                                @foreach ($dataSets as [$value, $change, $qtyTraded, $label])
                                    <td style="color: #ffb020;background-color: #161a20">
                                        <b>
                                            @if ($value >= 10000000)
    ...
    <script type="text/javascript">
        ...
        $("#expiry_date").change(function() {
            ...
            $.ajax({
                url: '{{ URL::to('get-midcapwithDt') }}/' + selectedOption,
                type: 'GET',
        ...
        $("#result").click(function(e) {
            ...
            $.ajax({
                url: '{{ URL::to('get-midcapwithDt') }}/' + selectedDt,
                type: 'GET',
                data: {
                    starting: starting,
                    ending: ending
