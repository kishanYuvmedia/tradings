            ...
            <div class="page-title-heading">
                ...
                <div style="display: flex">
                    <div class="col-md-12 col-sm-1"
                        style="color:white;font-family: -webkit-body;font-size: 49px;margin-top: -20px;color: powderblue;">
                        Trend Sarthi</div>
                </div>
            ...
            <div class="main-card mb-3 row">
                <div class="col-md-7">
                    <div class="card text-white bg-dark mb-3">
                        <div class="card-header">IO Decode</div>
                        <div class="card-body">
                        ...
                        <div class="card-body row">
                           ...
                           <div class="col-md-6 center">
                                ...
                                <div style="text-align: center;">
                                   <strong style="display: block;color: aquamarine"> <span class="dot"></span> Change PE OI</strong> 
                                   <span class="badge text-bg-light" id="putlabel">.....</span>
                                   <strong style="display: block;color: red" > <span class="dot"></span> Change CE OI</strong> 
                           ...
                           <div class="col-md-6">
                            ...
                            <div style="text-align: center;">
                                <strong style="display: block;color: aquamarine"> <span class="dot"></span> Total PE OI</strong> 
                                <span class="badge text-bg-light" id="putlabelOI">.....</span>
                                <strong style="display: block;color: red" > <span class="dot"></span> Total CE OI</strong> 
                                <span class="badge text-bg-light" id="calllabelOI">.....</span>
                                <h6 style="text-align: center;color: white;font-weight: bold">PCR: <span id="putIOlabel">02</span></h6>
                             </div>
                           </div>
                        </div>
                    </div>
        ...
        $(document).ready(function () {
            $.get('/chart-data/Nifty', function (data) {
                ...
                var chart = new Chart(ctx, {
                    ...
                    data: {
                        labels: ['Total Call (' + callPercentage.toFixed(2) + '%)', 'Total Put (' + putPercentage.toFixed(2) + '%)'],
                        datasets: [{
                            data: [callPercentage, putPercentage],
                            backgroundColor: ['rgba(255, 0, 0, 0.7)', 'rgba(17, 250, 242)'], // Colors for Call and Put
